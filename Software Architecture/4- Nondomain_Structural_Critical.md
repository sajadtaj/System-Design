...
اصطلاح *“architecture characteristics”* به‌صورت مستقیم اشاره دارد به **جنبه‌هایی از طراحی که برای موفقیت معماری حیاتی‌اند**.این مفهوم برخلاف *“nonfunctional requirements”* (نیازمندی‌های غیرعملکردی)،نشان‌دهنده‌ی دیدگاهی *پیش‌نگرانه و طراحی‌محور* است، نه دیدگاهی *پسینی و ارزیابانه*.
