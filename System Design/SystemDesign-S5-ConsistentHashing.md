...
### \[+] ابزارهای متن‌باز مرتبط با توزیع داده و Consistent Hashing:

* **Ketama**
  لینک: [https://github.com/RJ/ketama](https://github.com/RJ/ketama)
  توضیح: کتابخانه‌ای برای اجرای Consistent Hashing با پشتیبانی از node weighting. مناسب برای سیستم‌های cache مانند Memcached.

* **HashRing (پایتون)**
  لینک: [https://pypi.org/project/hashring/](https://pypi.org/project/hashring/)
  توضیح: یک پیاده‌سازی ساده از Consistent Hashing در پایتون که امکان اضافه/حذف سرورها بدون توزیع مجدد کل کلیدها را فراهم می‌کند.

* **Envoy Rate Limiter with Consistent Hashing**
  لینک: [https://www.envoyproxy.io](https://www.envoyproxy.io)
  توضیح: Envoy یک پروکسی لایه ۷ مدرن است که از توزیع بار با الگوریتم Consistent Hashing نیز پشتیبانی می‌کند.
...
> در طراحی **Amazon DynamoDB**، از الگوریتم Consistent Hashing برای توزیع داده‌ها بین **Partition Nodes** استفاده شده‌است. این طراحی باعث می‌شود با تغییر ظرفیت (افزودن یا حذف نود)، فقط درصد کمی از کلیدها جابه‌جا شوند.
>
> منبع: "Dynamo: Amazon's Highly Available Key-value Store", SOSP 2007

---

### \[+] ابزارهای متن‌باز برای Consistent Hashing (ادامه):

* **Consul by HashiCorp**
  لینک: [https://www.consul.io](https://www.consul.io)
  توضیح: سرویس کشف و توزیع بار که از consistent hashing برای مسیریابی درخواست‌ها به سرویس‌ها استفاده می‌کند.

* **Envoy Proxy**
  لینک: [https://www.envoyproxy.io](https://www.envoyproxy.io)
  توضیح: پراکسی لایه ۷ با پشتیبانی از الگوریتم‌های پیشرفته مانند Consistent Hashing برای توازن بار سرویس‌های میکروسرویس.
...
### \[+] ابزارهای Open-Source مرتبط با Consistent Hashing:

* **Consistent Hashing in Python**

  * لینک: [https://github.com/tonyyanga/consistent-hashing](https://github.com/tonyyanga/consistent-hashing)
  * معماری: پیاده‌سازی ساده الگوریتم hash ring با پشتیبانی از virtual nodes.
  * استفاده در پروژه‌های آموزشی، تست مفهومی و ابزارهای lightweight.

* **Ketama**

  * لینک: [https://github.com/RJ/ketama](https://github.com/RJ/ketama)
  * توضیح: پیاده‌سازی C از الگوریتم Consistent Hashing که توسط شرکت **Last.fm** توسعه داده شده.
  * استفاده در memcached برای load balancing.

* **HashRing (Node.js)**

  * لینک: [https://github.com/3rd-Eden/node-hashring](https://github.com/3rd-Eden/node-hashring)
  * مناسب برای توزیع کلیدها در محیط‌های Node-based و Redis cluster setups.
